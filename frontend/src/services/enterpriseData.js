...
export const DEMO_ACCOUNTS = [
  ...
  },
  {
    ...
    name: "Ananya Roy",
    role: RBAC_ROLES.SOC_MANAGER,
    department: "Cybersecurity / SOC",
    designation: "SOC Lead Manager",
    empId: "EMP-10002"
  },
  {
    username: "analyst",
  ...
  },
  {
    ...
    name: "Chen Wei",
    role: RBAC_ROLES.INCIDENT_RESPONDER,
    department: "Cybersecurity / SOC",
  ...
  },
  {
    ...
    email: "securityadmin@company.com",
    name: "Sarah Jenkins",
    role: RBAC_ROLES.SEC_ADMIN,
    department: "Cybersecurity / SOC",
...
export const ROLE_PERMISSIONS = {
  [RBAC_ROLES.SUPER_ADMIN]: {
    allowedTabs: ["dashboard", "alerts", "users", "my_profile"],
    ...
    canEnableDisableAccounts: true,
    canAddEditDeleteUsers: true,
  ...
  [RBAC_ROLES.SEC_ADMIN]: {
    allowedTabs: ["dashboard", "users", "my_profile"],
    canViewIAMDashboard: true,
    canViewGlobalDashboard: true,
    ...
    canBlockIP: true,
    canSimulateThreats: true,
    canMonitorTeam: false
  },
  [RBAC_ROLES.SOC_MANAGER]: {
    allowedTabs: ["dashboard", "alerts", "my_profile"],
    canViewGlobalDashboard: true,
    canViewAnalytics: true,
    canViewAlerts: true,
    canManageAlerts: true,
    ...
    canEnableDisableAccounts: false,
    canAddEditDeleteUsers: false,
  ...
  [RBAC_ROLES.SOC_ANALYST]: {
    allowedTabs: ["dashboard", "alerts", "users", "my_profile"],
    canViewGlobalDashboard: true,
    canViewAnalytics: true,
    canViewAlerts: true,
    canInvestigateAlerts: true,
    canManageAlerts: true,
    canEscalateAlerts: false,
    canResolveAlerts: false,
    canAssignAnalyst: false,
